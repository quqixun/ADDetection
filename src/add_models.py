...
class ADDModels(object):
    ...
    def __init__(self,
        ...
        '''__INIT__
            ...
            - scale: int or string, indicates that features are
                     extracted from which scale. If it is int,
                     available values are 1 to 5. If it is "all",
                     it is equivalent to 5. Default is "all".
    ...
    def _pyramid(self):
        ...
        if self.scale > 4:
            ...
            # Only use features of one scale
            fc2_bn = fts_used
